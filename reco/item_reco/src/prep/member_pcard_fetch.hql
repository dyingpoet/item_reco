...
INSERT OVERWRITE DIRECTORY '${hiveconf:paid_card_landing_dir}'
            SELECT 
                DISTINCT
            ...
            --ON (b.membership_nbr = c.membership_nbr and c.cardholder_status_code in ('A','P','F') and c.cardholder_type_code = 'P' and c.current_ind='Y' and b.current_ind = 'Y' and b.membership_obsolete_date>='${hiveconf:ds_obsolete_date_lb}') 
            ON (b.membership_nbr = c.membership_nbr and b.member_status_code in ('A','E','P') and c.cardholder_type_code = 'P' and c.current_ind='Y' and b.current_ind = 'Y' and b.membership_obsolete_date>='${hiveconf:ds_obsolete_date_lb}') 
