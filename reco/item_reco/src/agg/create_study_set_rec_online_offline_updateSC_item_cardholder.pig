...
-- 100001031^A41^A0001-01-01^A8255^A8255^A8255
...
TransOnline7 = JOIN Mem4 BY (membership_nbr, pdcardholder_nbr), TransOnline6 BY (membership_nbr, card_holder_nbr); 
...
TransOffline7 = JOIN Mem4 BY (membership_nbr, pdcardholder_nbr), TransOffline6 BY (membership_nbr, card_holder_nbr); 
