...
define scoreStreamPy `/usr/bin/python CoboughtModelMain.py subcat.txt cobought.txt seasonality.txt idf.txt $targetMonth $targetNumSubcats $method $targetIdf $outputThreshold`
