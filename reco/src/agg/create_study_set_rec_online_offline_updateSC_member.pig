...
TransOnline82 = GROUP TransOnline81 BY (membership_nbr, membership_create_date, pdcardholder_nbr, cat_subcat_nbr, visit_date);

TransOnline83 = FOREACH TransOnline82 GENERATE FLATTEN(group) AS (membership_nbr, membership_create_date, pdcardholder_nbr, cat_subcat_nbr, visit_date),
...
TransOffline82 = GROUP TransOffline81 BY (membership_nbr, membership_create_date, pdcardholder_nbr, cat_subcat_nbr, visit_date);

TransOffline83 = FOREACH TransOffline82 GENERATE FLATTEN(group) AS (membership_nbr, membership_create_date, pdcardholder_nbr, cat_subcat_nbr, visit_date),
